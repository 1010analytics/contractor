    ...
    <SidebarContainer>
      ...
      <BottomSection>
        <Box sx={{ marginTop: '20px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          <MenuButton fullWidth onClick={() => navigate('/contractor-dashboard')}>Dashboard</MenuButton>
          <MenuButton fullWidth onClick={() => navigate('/verify-contractors')}>Verify Contractors</MenuButton>
          <MenuButton fullWidth onClick={() => navigate('/manage-services')}>Manage Services</MenuButton>
        </Box>
